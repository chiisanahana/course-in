                        ...
                        <div> 
                            ...
                            <div class="d-flex align-items-center justify-content-between card-atm border rounded"> 
                                <div class="fab fa-cc-visa ps-3"></div> 
                                    <input type="text" class="form-control @error('card_details') is-invalid @enderror" placeholder="Card Details" name="card_details" value="{{old('card_details')}}"> 
                                    <div class="d-flex w-50"> 
                                        <input type="text" class="form-control px-0 @error('exp_date') is-invalid @enderror" placeholder="MM/YY" name="exp_date" value="{{old('exp_date')}}"> 
                                        <input type="password" maxlength=3 class="form-control px-0 @error('cvv') is-invalid @enderror" placeholder="CVV" name="cvv" value="{{old('cvv')}}"> 
                                    </div> 
                                </div> 
